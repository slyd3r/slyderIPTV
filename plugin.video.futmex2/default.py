...
line1 = "  ------BIENVENIDOS A [COLOR blue]...FUTMEX...[/COLOR]ESTE ADDON ES GRATIS Y ESTA PROHIBIDA SU VENTA.....[COLOR yellow][B]FUTMEX[/B][/COLOR]'"
...
Base = 'http://koditvonline2016.blogspot.com/p/futmex-addon.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.FUTMEX') #    modificar("el nombre de tu addons")
