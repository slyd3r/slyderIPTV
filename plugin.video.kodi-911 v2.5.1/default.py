...
Base = 'http://chocolatinoiptv.blogspot.com/p/codificacion-del-addon-kodi-911.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.kodi-911') #    modificar("el nombre de tu addons")
