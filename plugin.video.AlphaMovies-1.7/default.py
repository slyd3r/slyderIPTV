            ...
            if k in regexs:
                ...
                if m['page'] and m['page'] in cachedPages and not 'ignorecache' in m and forCookieJarOnly==False :
                    ...
                    if m['page'] and  not m['page']=='' and  m['page'].startswith('http'):
                        ...
                        req.add_header('User-Agent', 'lemonade')
                        if 'refer' in m:
...
def search(site_name,search_term=None):
    ...
    if 'youtube' in site_name:
        ...
        headers = dict({'User-Agent':'lemonade','Referer': 'http://joker.org/','Accept-Encoding':'gzip, deflate','Content-Type': 'application/json;charset=utf-8','Accept': 'application/json, text/plain, */*'})
